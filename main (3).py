...
if __name__ == '__main__':
    ...
    parser.add_argument('--user_emb_path', default='data/ref/lastfm/test_user_embedding.npy', type=str)
    parser.add_argument('--item_emb_path', default='data/ref/lastfm/item_embedding.npy', type=str)
    parser.add_argument('--tau_path', default='./checkpoints/trained_tau.pth', type=str)
    parser.add_argument('--lambda_path', type=str, default="", help="Path to .pth file with {'lambda': float}")
